...
import CorematContext from '../../contextProvider/CorematContext';
...
const BackgroundSettingSection = () => {
  const { showBackground, setBackgroundVisibility, backgroundStyle, setBackgroundStyle } = useContext(CorematContext);
